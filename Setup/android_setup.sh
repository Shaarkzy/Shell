...
echo -e "\n${YELLOW}INSTALLING NETIFACES 8/12${NC}\n"
pip install netifaces
echo -e "\n${YELLOW}DONE INSTALLING NETIFACES 8/12${NC}\n"

echo -e "\n${BLUE}INSTALLING PHONENUMBERS 9/12${NC}\n"
pip install phonenumbers
echo -e "\n${BLUE}DONE INSTALLING PHONENUMBERS 9/12${NC}\n"

echo -e "\n${GREEN}INSTALLING PYCRYPTODOME 10/12${NC}\n"
pip install pycryptodome
echo -e "\n${GREEN}DONE INSTALLING PYCRYPTODOME 10/12${NC}\n"

echo -e "\n${YELLOW}INSTALLING PROMPT TOOLKIT 11/12'${NC}\n"
pip install prompt_toolkit
echo -e "\n${YELLOW}DONE INSTALLING PROMPT TOOLKIT 11/12${NC}\n"

echo -e "\n${YELLOW}INSTALLING BEUTIFULSOUP 12/12'${NC}\n"
pip install bs4
